...
<!-- SECTION:NOTES:BEGIN -->
REOPENED IN SCOPE BY TASK-337 (2026-08-15). This task's AC 'a vector MMIO access never loops' holds only for accesses routed through vpart/vpart_store. Eight *_run families and exec_v_broadcast_m call Memory::read/write or StrMem::sload/sstore directly and still hang — measured, see task-337. The tests here only exercise movdqu, which converges.
<!-- SECTION:NOTES:END -->
