...
The vextracti32x4 case uses the EVEX encoding because the VEX vextracti128 memory-destination form is not lifted (lift/mod.rs:1861 'mem dst deferred') — filed as TASK-208.
