...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 guest timespec/timeval reads near u64::MAX do not panic in debug builds; a test drives a syscall with a near-max pointer and gets a clean errno/degradation
<!-- AC:END -->
