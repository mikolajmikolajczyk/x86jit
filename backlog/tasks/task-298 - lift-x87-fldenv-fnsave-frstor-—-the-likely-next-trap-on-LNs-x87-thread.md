...
- [x] #3 differential-tested against Unicorn, with any deliberate divergence measured and named the way TASK-297 did
<!-- AC:END -->
...
Tests assert ExitKind::Hlt on both engines, because a jit_eq_interp parity check alone cannot prove a lift exists (an unlifted opcode traps identically in both tiers - observed on task-301).
