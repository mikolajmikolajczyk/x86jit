...
No guest trap output backs this one: the encodings come from the Intel SDM and should be pinned with an llvm-mc or objdump witness, the way task-230 pinned vextractf128.
