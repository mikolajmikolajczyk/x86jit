...
NOT task-112: this does NOT fix the caddy corruption (Go's lock release uses atomic xchg, dodging this exact manifestation; caddy fixed-arm 9/25 vs baseline 18/40, p~0.46 — no effect). Separate, independent MT-correctness bug. Full suite 255/255 green with the fix.
