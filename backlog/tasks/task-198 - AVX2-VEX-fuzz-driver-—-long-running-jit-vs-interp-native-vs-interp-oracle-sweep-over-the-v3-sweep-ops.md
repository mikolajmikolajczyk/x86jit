...
First full run: 137166 programs, 22778 native-oracle runs, 25 distinct signatures, seed 1..453246. Triage found the integer and lane lowerings bit-exact vs hardware (zero genuine divergences); every real finding was float. Follow-ups filed from it: TASK-199 (f32_to_f16 directed rounding).
