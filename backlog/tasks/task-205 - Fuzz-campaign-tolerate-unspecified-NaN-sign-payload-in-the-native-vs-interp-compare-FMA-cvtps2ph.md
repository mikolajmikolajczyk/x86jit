...
- vcvtps2ph: e.g. seed 51 → native 0x7e00 vs interp 0x7e01, both QNaNs (the low payload bit). The TASK-199 rounding fix is unaffected — the diverging lane is a NaN, not a rounded finite value.
