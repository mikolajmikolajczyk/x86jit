...
Found by the AVX fuzz campaign (TASK-198) after the has_legacy_vec filter was removed (TASK-200) — a bystander in a mixed program, shrunk to a base-GPR shift; not a vector bug.
