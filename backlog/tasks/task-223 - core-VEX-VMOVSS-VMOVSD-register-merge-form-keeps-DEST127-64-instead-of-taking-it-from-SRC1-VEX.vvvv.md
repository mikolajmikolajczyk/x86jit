...
`x86jit-cranelift` at this repo's rev — neither project's test suite involved:
...
and without `set_cpu_mode(Long64)`, and identical between rev and the working tree —
