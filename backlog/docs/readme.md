...
| [`../../PROVENANCE.md`](../../PROVENANCE.md) | Where the engine's behaviour comes from: the authoritative sources (Intel SDM, AMD APM, psABI), what is only an oracle, what is deliberately not modelled, and the licence surface. |
| [`performance.md`](performance.md) | Recorded interp/JIT/native timings (generated by `x86jit-bench`). |
