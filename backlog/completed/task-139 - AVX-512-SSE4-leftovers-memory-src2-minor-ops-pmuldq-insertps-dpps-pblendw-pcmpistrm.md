...
<!-- SECTION:NOTES:BEGIN -->
Partial (task-159): pmuldq/vpmuldq (MulS32) and pblendw (SSE word blend) lifted + jit==interp tested. REMAINING: insertps, dpps, pcmpistrm, and any other listed minor ops. Memory-src2 for several EVEX ops also landed under 215.
<!-- SECTION:NOTES:END -->
