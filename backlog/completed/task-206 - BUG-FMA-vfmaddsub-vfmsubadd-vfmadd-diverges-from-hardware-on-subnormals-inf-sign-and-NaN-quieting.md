...
- [ ] #4 cargo xfuzz --family fma --secs 120 reports zero non-NaN-payload divergences (the TASK-205 tolerance still applies to genuine unspecified payload)
...
<!-- SECTION:NOTES:BEGIN -->
Merged into the AVX float divergences task 2026-08-11: same campaign, same float helper paths, and the vdpps jit-vs-interp axis is the thread worth pulling first.
<!-- SECTION:NOTES:END -->
