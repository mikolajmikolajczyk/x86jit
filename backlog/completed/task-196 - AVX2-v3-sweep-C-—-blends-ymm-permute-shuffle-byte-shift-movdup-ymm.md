...
Widen to ymm: Vblendpd/ps (imm8), Vblendvpd/ps, Vpblendvb, Vpblendw; Vpermilps/pd (reg + imm), Vpermps, Vpshufhw/lw, Vpslldq/Vpsrldq, Vmovddup/shdup/sldup. Parameterize the existing VBlend*/VShuffle*/VByteShift/VPermil IrOps by width (bytes 16 vs 32, two-128-half where lane-crossing rules require). All three tiers, jit==interp, native-oracle + jit tests per task-193. Owns those shuffle/blend helpers.
