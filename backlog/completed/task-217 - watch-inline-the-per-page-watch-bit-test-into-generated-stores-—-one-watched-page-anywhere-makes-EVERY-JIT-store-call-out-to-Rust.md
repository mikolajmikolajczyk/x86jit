...
THE FIX vs THE REVERT. task-217-v1 put the inline page-bit test in the HOT stream; the
...
Restored: Memory::watch_bits_ptr / watch_bits_cover_size, MemCtx.watch_bits_ptr at
