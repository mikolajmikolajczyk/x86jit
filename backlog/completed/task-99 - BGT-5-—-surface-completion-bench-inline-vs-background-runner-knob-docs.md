...
Phase 5 of background-tier-plan.md (doc-22). Measure and finish the surface; the numbers feed the maintainer's open decision on the x86jit-run default.
...
- x86jit-run (lib.rs:275, TIER_UP_AFTER): env knob for background; default stays inline pending the numbers (open decision 4 in doc-22).
