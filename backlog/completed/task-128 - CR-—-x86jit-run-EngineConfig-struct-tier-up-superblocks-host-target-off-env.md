...
<!-- SECTION:NOTES:BEGIN -->
Sequencing: do TASK-54 (unemulinux) (merge run+oci into x86jit-cli) FIRST — this EngineConfig work then lands in the merged x86jit-cli lib instead of x86jit-run. The design is unchanged; only the crate/paths move.
<!-- SECTION:NOTES:END -->
