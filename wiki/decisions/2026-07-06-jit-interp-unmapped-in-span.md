# JIT reads demand-zero for an unmapped-in-span access; interp traps — known oracle gap

**Date:** 2026-07-06
**Decider:** Mikołaj Mikołajczyk (via code-review session)
**Tags:** memory-model | jit | oracle | softmmu
...
- ADR-0001 (`wiki/adr/0001-reserved-sparse-mmap-backing.md`) — the flat one-add
  translation and the "no per-page protection" stance this extends.
- `wiki/tasks/code-review.md` #4 — the finding this resolves.
