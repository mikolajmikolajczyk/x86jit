# ADR-0001: `Reserved` memory model — sparse host-mmap backing, no per-page protection

- **Status** — Accepted
- **Date** — 2026-07-06
- **Deciders** — Mikołaj Mikołajczyk
- **Tags** — memory-model, softmmu, address-space, backends, go
- **Spec** — §4.1 (memory model), §8.2.1 (compiled-block ABI)
